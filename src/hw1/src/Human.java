...
public class Human implements Creature {
    ...
    public Human(String name, double running_speed, double jumping_height){
        this.name = name;
    ...
    public boolean run(double speed){
        ...
        String message = (res) ? "Human " + this.getName() + " managed to run treadmill." : "Human  " + this.getName() +  " couldn't run treadmill.";
    ...
    public boolean jump(double height){
        ...
        String message = (res) ? "Human  " + this.getName() +  " managed to jump over the wall." : "Human  " + this.getName() +  " couldn't jump over the wall.";
        System.out.println(message);
        return res;
    }
}