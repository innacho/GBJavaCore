...
public class Cat implements Creature {
    ...
    public Cat(String name, double running_speed, double jumping_height){
        this.name = name;
    ...
    public boolean run(double speed){
        ...
        String message = (res) ? "Cat " + this.getName() +  " managed to run treadmill." : "Cat " + this.getName() +  " couldn't run treadmill.";
    ...
    public boolean jump(double height){
        ...
        String message = (res) ? "Cat " + this.getName() +  " managed to jump over the wall." : "Cat " + this.getName() +  " couldn't jump over the wall.";
        System.out.println(message);
        return res;
    }
}